...
export const WIDGETS: WidgetConfig[] = [
  {
    ...
    integrations: [
      ...
      },
      {
        ...
        title: "Headless API",
        description:
          "Fetch changelog data via REST API and render it in your own UI. Audience-targeted posts are filtered client-side with the glintpost-targeting.js helper. You generate and persist a visitor ID on your side for like/dislike deduplication. Set your allowed domain in Settings for cross-origin access.",
      },
      {
        mode: "advanced",
