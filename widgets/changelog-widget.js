// SOURCE for public/changelog-widget.js — bundled by scripts/build-widgets.mjs.
...
(function () {
  ...
  if (previewShowAll) queryParams.set("preview", "all");
  ...
  function matchesTargeting(post) {
    ...
    return matchTargeting(post.targeting || null, visitorDatalayer);
  }
